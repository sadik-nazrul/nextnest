...
const Footer = () => {
    return (
        <footer className="flex flex-col lg:flex-row md:flex-row gap-4 justify-between items-center p-4 bg-slate-100 text-orange-500 text-lg lg:px-10 md:px-8 px-2">
